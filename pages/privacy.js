...
const Privacy = ({ authUser }) => (
    <Page contentClassName="content-big" header={<Header user={authUser}/>}>
        ...
        <h2>Use of Data</h2>
        <p>GenHub uses the collected data for various purposes:</p>
        <ul>
        ...
        <p>GenHub may disclose your Personal Data in the good faith belief that such action is necessary to:</p>
        <ul>
            <li>To comply with a legal obligation</li>
            <li>To protect and defend the rights or property of GenHub</li>
        ...
        <ul>
            <li>By email: lazoviccorp@gmail.com</li>
        </ul>
        <style jsx global>{`
            body {
